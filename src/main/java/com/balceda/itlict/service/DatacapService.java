...
public class DatacapService {
    final String baseurl = "169.57.15.56/tmweb.net/";
    final String logonuri = "Session/Logon";
    final String transtarturi = "Transaction/Start";
    final String tranexecuteuri = "Transaction/Execute";
    final String logouturi = "Session/Logoff";
